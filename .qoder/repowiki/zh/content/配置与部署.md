...
## 更新摘要
**变更内容**
- 新增RUN.md运行文档，提供完整的项目运行指南
- 更新依赖管理章节，反映requirements.txt的重大更新
- 新增Crawl4AI和Scrapling等新依赖的安装说明
- 更新测试框架配置，增强功能验证
- 完善社区抓取组件的AI增强功能
...
subgraph "存储层"
O1["JSON 输出<br/>news_result.json/comments_*.json"]
end
subgraph "分析层"
A1["情感分析<br/>关键词统计"]
A2["AI 内容理解<br/>NLP/ML 模型"]
end
S1 --> P1 --> O1
S2 --> P1 --> O1
S3 --> P1 --> O1
...
### 运行文档与使用指南
- 详细运行说明
  - 参考 docs/RUN.md 获取完整的安装、配置与运行指南。
  - 包含系统要求、安装步骤、运行命令与参数说明。
- 工作流程示例
  - 提供从专业新闻抓取到社区评论分析的完整工作流。
  - 包含常见问题处理与性能优化建议。
